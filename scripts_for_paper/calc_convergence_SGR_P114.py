...
if (len(sys.argv) < 2):
  print "Usage: python calc_convergence_SGR_P114.py <base_output_directory>"
  exit()
outpath = sys.argv[1]
...
configuration = 'RKZ_A1_B1_C2_ql17_lmt4_sgr114'
...
for time in timeList:
  ...
  fileName = './data/SGR_P114_convergence_data_%d.txt' % time
