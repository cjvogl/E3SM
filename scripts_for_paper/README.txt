...
Vogl et al. (2020) Improving time-step convergence in an atmosphere model with simple
physics: a sub-grid reconstruction framework for alternative closure with
numerical robustness.  Journal of Advances in Modeling Earth Systems.

The namelists directory contains E3SM (ACME) namelists that can be used to generate
the convergence test output used in Vogl et al. (2020).
...
plots in Vogl et al. (2020).  The convergence test plots will use the post-processed
