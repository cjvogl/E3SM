...
module macrop_driver
  ...
  integer :: &
    ...
    astwatold_idx,&! astwatold index in physics buffer (simple condensation model,cjv)
  ...
  !-----------------------------------------------------------------------
    ...
    call pbuf_add_field('ASTWATOLD','global',  dtype_r8, (/pcols,pver,dyn_time_lvls/), astwatold_idx)
